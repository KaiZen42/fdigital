        ...
        return(
            ...
            <Box sx={{width: '100%', textAlign: 'center'}}>
                ...
                {numOfWeek == 6 ? <>
                    ...
                    <iframe className="youtubeEmb" src={first ? libreria.find(element => element.type == "youtube").path : libreria.find(element => element.type == "youtube").secondVideo} title="YouTube video player" frameBorder="0" controls="1" allowFullScreen allow="autoplay"/>
                    </Grid>
                ...
                <>
                <Grid className="iframe-wrapper">
                <iframe className="youtubeEmb" src={libreria.find(element => element.type == "youtube").path} title="YouTube video player" frameBorder="0" controls="1" allowFullScreen allow="autoplay"/>
                </Grid>
                <Grid container height="7vh" direction="row" justifyContent="center" alignItems="flex-end">
                    <ThemeProvider theme={theme}>
