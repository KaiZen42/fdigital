	  ...
	  <Router>
		...
		<div id="content">
			...
			<main id="main" className="main container col-md-9 ml-sm-auto col-lg-10 px-4 d-flex justify-content-between flex-wrap flex-nowrap align-items-center pt-3 pb-2 mb-3">
				...
				<Route path={`${loc}test`} component={() => <Test setEmailCount={setEmailCount} setTestSection={setTestSection} setNotify={setNotify} deactivate={deactivate}/>} setSerie={setSerie} serie={serie}/>
			</main>
			</div>
		</div>
	</Router>
